...
**Priority**: High | **Effort**: High | **Status**: Partial | **Issue**: [#43](https://github.com/viogus/frp-rs/issues/43)
...
**Priority**: Medium | **Effort**: Medium | **Status**: Gap | **Issue**: [#44](https://github.com/viogus/frp-rs/issues/44)
...
**Priority**: Medium | **Effort**: Medium | **Status**: Gap | **Issue**: [#46](https://github.com/viogus/frp-rs/issues/46)
...
### 2.1 V2 + QUIC interop
**Priority**: Medium | **Effort**: Medium | **Status**: TODO | **Issue**: [#43](https://github.com/viogus/frp-rs/issues/43)
...
**Priority**: Medium | **Effort**: Medium | **Status**: Gap | **Issue**: [#43](https://github.com/viogus/frp-rs/issues/43)
...
**Priority**: Low | **Effort**: Low | **Status**: Gap | **Issue**: [#64](https://github.com/viogus/frp-rs/issues/64)
...
**Priority**: High | **Effort**: Medium | **Status**: None | **Issue**: [#47](https://github.com/viogus/frp-rs/issues/47)
...
**Priority**: Medium | **Effort**: Low | **Status**: Trivial | **Issue**: [#53](https://github.com/viogus/frp-rs/issues/53)
...
**Priority**: Low | **Effort**: Low | **Status**: Gap | **Issue**: [#65](https://github.com/viogus/frp-rs/issues/65)
...
**Priority**: Medium | **Effort**: High | **Status**: None | **Issue**: [#51](https://github.com/viogus/frp-rs/issues/51)
...
**Priority**: Medium | **Effort**: High | **Status**: None | **Issue**: [#52](https://github.com/viogus/frp-rs/issues/52)
...
**Priority**: Low | **Effort**: Medium | **Status**: Gap | **Issue**: [#62](https://github.com/viogus/frp-rs/issues/62)
...
**Priority**: Low | **Effort**: Medium | **Status**: None | **Issue**: [#59](https://github.com/viogus/frp-rs/issues/59)
...
**Priority**: Low | **Effort**: Medium | **Status**: None | **Issue**: [#63](https://github.com/viogus/frp-rs/issues/63)
...
**Priority**: High | **Effort**: Medium | **Status**: None | **Issue**: [#49](https://github.com/viogus/frp-rs/issues/49)
...
**Priority**: High | **Effort**: Medium | **Status**: Gap | **Issue**: [#50](https://github.com/viogus/frp-rs/issues/50)
...
**Priority**: Medium | **Effort**: Medium | **Status**: None | **Issue**: [#55](https://github.com/viogus/frp-rs/issues/55)
...
**Priority**: Medium | **Effort**: Medium | **Status**: None | **Issue**: [#56](https://github.com/viogus/frp-rs/issues/56)
...
**Priority**: Low | **Effort**: Medium | **Status**: Partial | **Issue**: [#60](https://github.com/viogus/frp-rs/issues/60)
...
**Priority**: Low | **Effort**: Low | **Status**: Gap | **Issue**: [#58](https://github.com/viogus/frp-rs/issues/58)
...
**Priority**: Medium | **Effort**: Medium | **Status**: None | **Issue**: [#57](https://github.com/viogus/frp-rs/issues/57)
...
**Priority**: Low | **Effort**: Low | **Status**: Gap | **Issue**: [#61](https://github.com/viogus/frp-rs/issues/61)
...
| # | Item | Issue | Effort |
|---|------|-------|--------|
| 3.2 | Real `/healthz` with readiness check | [#53](https://github.com/viogus/frp-rs/issues/53) | 1h |
...
| # | Item | Issue | Effort |
|---|------|-------|--------|
| 3.1 | OpenTelemetry tracing | [#47](https://github.com/viogus/frp-rs/issues/47) | 1d |
| 5.1 | Buffer pooling | [#49](https://github.com/viogus/frp-rs/issues/49) | 1d |
| 5.2 | axum out of frp-core | [#50](https://github.com/viogus/frp-rs/issues/50) | 0.5d |
| 1.2 | Plugin hooks (Ping/NewWorkConn/NewUserConn) | [#44](https://github.com/viogus/frp-rs/issues/44) | 0.5d |
| 1.5 | Config store file persistence | [#46](https://github.com/viogus/frp-rs/issues/46) | 1d |

## Major Features

| # | Item | Issue | Effort |
|---|------|-------|--------|
| 1.1 | V2 protocol full transport wiring | [#43](https://github.com/viogus/frp-rs/issues/43) | 3d |
| 4.1 | gRPC management API | [#51](https://github.com/viogus/frp-rs/issues/51) | 3d |
| 4.2 | WASM plugin system | [#52](https://github.com/viogus/frp-rs/issues/52) | 5d |
| 1.3 | Virtual Net (L3 VPN) | [#48](https://github.com/viogus/frp-rs/issues/48) | 5d |
