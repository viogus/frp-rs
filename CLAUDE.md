...
| `cargo test --workspace --all-features` | 1205 passed, 0 failed (full suite incl. dashboard — requires an all-features frps binary, see Testing & Tooling) |
...
| `compat-test.sh` (Go frp v0.71.0) | 86 passed, 0 failed (run_test + XTCP pairwise; re-verified locally vs Go 0.71.0 on 2026-08-26) |
