...
# Skip the append when the block already exists, so the script works both
# standalone and after the workflow's write. (Round-17 review LOW: the
# unconditional append re-introduced the duplicate-key bug.)
