> **Status: historical record.** This is the feature backlog that was tracked in
> the repository root as `TODO.md` through 2026-09. It is kept because it records
> which parity items were resolved and which were deliberately closed
> not-planned — not because anything here is still actionable.
>
> The **live** backlog is [`../../TODO.md`](../../TODO.md).
> Round-by-round hardening history is in [`development-log.md`](development-log.md).
...
> [`development-log.md`](development-log.md) and the
